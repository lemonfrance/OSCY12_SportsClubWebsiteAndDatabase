...
include "koac_connection16.php";
	...
	if (isset($_POST['announce_ttl'])){
		echo "Successfully added announcement title. <br>";
		$announce_ttl = $_POST['announce_ttl'];
	}
	else {
	...
	if (isset($_POST['announce_body'])){
		echo "Successfully added announcement content. <br>";
		$announce_body = $_POST['announce_body'];
	}
	else {
		echo "No content added; can't be left null. Failed adding new announcement. <br>";
	}
	
	$sql = "INSERT INTO $tablename(BulletinSection, Title, Body) VALUES('Announcements','$announce_ttl','$announce_body')";
