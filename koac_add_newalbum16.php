...
$storepath = 'album_covers/'.basename($_FILES['newalbumcover']['name']);

if (isset($_POST['newalbum_name'])){
	$newalbum_name = $_POST['newalbum_name'];
}
if (empty($_POST['newalbum_name'])){
	echo "New album name can't be left null.";
}


if (isset($_FILES['newalbumcover']['name'])){
	$newalbumcover = $_FILES['newalbumcover']['name'];
}
if (empty($_FILES['newalbumcover']['name'])){
	echo "New album cover can't be left null.";
}

$sql = "INSERT INTO club_albums(AlbumName, AlbumCover) VALUES('$newalbum_name','$newalbumcover')";
mysqli_query($conn,$sql);

if(move_uploaded_file($_FILES['newalbumcover']['tmp_name'],$storepath)){
	echo "Successfully created new album &nbsp".$newalbum_name.".";
}
else{
...
?>
<p>
<input type="submit" name="" formaction="koac_adminwebsite16.php" value="Go back to Admin - Website">
</p>
</form>
 <div id= 'admin_footer'>
