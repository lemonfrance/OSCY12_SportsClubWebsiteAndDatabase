...
include "koac_connection16.php";
	...
	if (isset($_POST['vacantjob'])){
		$vacantjob = $_POST['vacantjob'];
		echo "Successfully added vacant job &nbsp".$vacantjob.". <br>";
	}
	else {
		echo "Job not indicated; can't be left null. Failed adding vacant job. <br>";
	}
	
	if (isset($_POST['jobdesc'])){
		$jobdesc = $_POST['jobdesc'];
		echo "Successfully added vacant job description &nbsp".$jobdesc.". <br>";
	}
	else {
		echo "No job description added; can't be left null. Failed adding vacant job. <br>";
	}
	
	$sql = "INSERT INTO $tablename(Job, JobDescription) VALUES('$vacantjob', '$jobdesc')";
