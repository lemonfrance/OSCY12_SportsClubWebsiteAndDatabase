...
$addpts = $_POST['addpts'];
$addpts_points = $_POST['addpts_points'];
$addpts_date = $_POST['addpts_date'];

$sql = "INSERT INTO club_results(EventDate, Points, MemberNo) VALUES('$addpts_date','$addpts_points','$addpts')";
$result = mysqli_query($conn,$sql);

if($result){
	echo "Successful insertion of new points.";
}
else{
