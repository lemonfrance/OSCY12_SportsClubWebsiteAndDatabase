...
<p>
Select Applicant:
<select id="dropbox" name="employ_applicant">
<?php
include "koac_connection16.php";
$sql = "SELECT * FROM club_employment";
...
<p> <input type="submit" formaction="koac_adminemploy_acc16.php" value="Accept"/> 
<input type="submit" formaction="koac_adminemploy_dec16.php" value="Decline"/>  </p>
...
<?php
include "koac_connection16.php";
$employ_sql = "SELECT * FROM club_employment";
$employ_result = mysqli_query($conn,$employ_sql);
...
if($employ_result){
	...
	echo "<th>School/Workplace</th>";
	echo "<th>Had Been a Member/Employee Before</th>";
	echo "<th>New Zealand Resident</th>";
	echo "<th>Chosen Job</th>";
	echo "</tr>";
	while ($row= mysqli_fetch_assoc($employ_result)){
		echo "<tr>";
		echo "<td>".$row['ID']."</td>";
		...
		echo "<td>".$row['School_Workplace']."</td>";
		echo "<td>".$row['Member_EmpBefore']."</td>";
		echo "<td>".$row['NZResident']."</td>";
		echo "<td>".$row['ApplyJob']."</td>";
		echo "</tr>";
	}
	echo "</table>";
}
