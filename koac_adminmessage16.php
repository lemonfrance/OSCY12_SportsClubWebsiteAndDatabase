...
<p class="titles" id="bodyttl"> Messages: </p>

<p>*Answer questions through any of the contact details submitted</p>
<p>
<?php
include "koac_connection16.php";

$sql = "SELECT * FROM club_messages";
...
if($result){
	...
	while ($msg = mysqli_fetch_assoc($result)){
		echo "<tr>";
		echo "<td>".$msg['SenderName']."</td>";
		echo "<td>".$msg['SenderPhoneNo']."</td>";
		echo "<td>".$msg['SenderEmail']."</td>";
		echo "<td>".$msg['SenderMessage']."</td>";
		echo "</tr>";
	}
	echo "</table>";
}
