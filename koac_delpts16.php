...
$delpts_member = $_POST['delpts_member'];
$delpts_eventdate = $_POST['delpts_eventdate'];

$sql = "DELETE FROM club_results 
WHERE MemberNo LIKE '$delpts_member' AND EventDate LIKE '$delpts_eventdate'";
$result = mysqli_query($conn, $sql);
if($result){
	echo "Successful deletion of member number &nbsp".$delpts_member;
}
else{
