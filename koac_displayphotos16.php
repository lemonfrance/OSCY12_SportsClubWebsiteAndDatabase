...
$openalbum = $_POST['album'];
$sql = "SELECT * FROM club_albumphotos WHERE AlbumName LIKE '$openalbum'";
$result = mysqli_query($conn,$sql);

if($result){
	echo "<p id='orangefont'>".$openalbum."</p>";
	echo "<br>";
	while ($photos = mysqli_fetch_assoc($result)){
		echo "<p> <img src='album_photos/".$photos['Photo']."'> </p>";
...
<p>
<input type='submit' value='Go back to Photo Gallery' formaction='koac_photogallery16.php'/>
</p>
