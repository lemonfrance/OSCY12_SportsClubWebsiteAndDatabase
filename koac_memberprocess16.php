...
<p class="titles" id="bodyttl"> Apply for Membership </p>
...
$sql = "INSERT INTO club_applymember(FirstName, LastName, Parent_or_Guardian, StreetAddress, Suburb, PhoneNo, Birthdate, Grade, MemberBefore, NZResident)
VALUES ('$firstname', '$lastname', '$parents', '$street', '$suburb', '$phone', '$birth', '$gr', '$memberb4', '$nzres')";
...
if ($result){
	...
	echo "<form enctype='multipart/form data' action='koac_memberform16.php' method='POST'>";
	echo "Your application form has been declined due to an error. <br>";
	echo mysqli_errno($conn).":".mysqli_error($conn)."<br>";
	echo "<input type='submit' value='Go Back to Membership Application Form'>";
}
