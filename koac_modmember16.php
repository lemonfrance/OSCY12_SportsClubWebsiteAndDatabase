...
$mod_firstname = $_POST['mod_firstname'];
$mod_lastname = $_POST['mod_lastname'];
$mod_parents = $_POST['mod_parents'];
$mod_street = $_POST['mod_street'];
$mod_suburb = $_POST['mod_suburb'];
$mod_phone = $_POST['mod_phone'];
$mod_birth = $_POST['mod_birth'];
$mod_gr = $_POST['mod_gr'];

$modmember = $_POST['modmember'];

$sql = "UPDATE club_members 
SET FirstName = '$mod_firstname', LastName = '$mod_lastname', Parent_or_Guardian = '$mod_parents', StreetAddress = '$mod_street', Suburb = '$mod_suburb', PhoneNo = '$mod_phone', Birthdate = '$mod_birth', Grade = '$mod_gr'
WHERE MemberNo LIKE $modmember"; 
$result = mysqli_query($conn, $sql);
if($result){
	echo "Successful update of member number &nbsp".$modmember;
}
else{
	echo "Member details modification error:".mysqli_errno($conn).":".mysqli_error($conn);
}
?>
