...
$modpts_member = $_POST['modpts_member'];
$modpts_eventdate = $_POST['modpts_eventdate'];
$modnewpts_points = $_POST['modnewpts_points'];
$modnewpts_date = $_POST['modnewpts_date'];

$sql = "UPDATE club_results
SET EventDate = '$modnewpts_date', Points = '$modnewpts_points'
WHERE MemberNo LIKE '$modpts_member' AND EventDate LIKE '$modpts_eventdate'";

$result = mysqli_query($conn,$sql);

if($result){
	echo "Successful update of points.";
}
else{
