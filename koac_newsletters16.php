...
<meta name="title" content="Kiwi Ormiston Athletic Club - Newsletters">
<meta name="keyword" content="kiwi ormiston athletic club,kiwi ormiston,kiwi,ormiston,sports,athletic,club,koac,koac news,kiwi ormiston news,koac newsletters,kiwi ormiston newsletters">
<meta name="description" content="Monthly newsletters to update everyone about the club."/>
<meta name="revised" content="27/08/2017"/>
<title> Kiwi Ormiston Athletic Club - Newsletters </title>
...
<p class="titles" id="bodyttl"> Newsletters </p>
...
$sql = "SELECT * FROM club_newsletters";
$result = mysqli_query($conn, $sql);

if($result){
	while ($news = mysqli_fetch_assoc($result)){
		echo "<a target='_blank' href='newsletters/".$news['NewsletterFile']."'>";
		echo "<p>".$news['NewsletterTitle']."</p>";
		echo "</a>";
	}
}
else{
