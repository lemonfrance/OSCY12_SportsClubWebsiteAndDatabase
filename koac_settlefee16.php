...
$sql1 = "SELECT * FROM club_members WHERE MemberNo LIKE '$unpaidmember'";
$result1 = mysqli_query($conn, $sql1);

$row = mysqli_fetch_assoc($result1);
$payment = $row['AnnualFee'];

$sql2 = "UPDATE club_members
SET AmountPaid = '$payment', HasPaid = 'TRUE', DatePaid = '$datepaid'
WHERE MemberNo LIKE '$unpaidmember'";
$result2 = mysqli_query($conn, $sql2);

if ($result2){
	echo "<p> Successfully settled member number &nbsp".$unpaidmember."'s payment </p>";
}
else{
